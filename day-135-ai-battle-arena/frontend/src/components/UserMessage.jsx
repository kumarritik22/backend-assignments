  ...
  return (
    <div className="flex justify-end mb-10 mt-6 relative z-10">
      <div className="flex gap-4 max-w-3xl w-full justify-end">
        <div className="bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 px-5 py-3 md:px-6 md:py-4 rounded-3xl rounded-tr-sm text-base leading-relaxed break-words shadow-sm border border-slate-200/60 dark:border-slate-700/50">
          {message}
        </div>
