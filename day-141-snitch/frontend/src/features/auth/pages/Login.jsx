      ...
      <main className="flex flex-col-reverse md:flex-row min-h-screen md:h-screen md:overflow-hidden bg-[#F6F5F2] dark:bg-[#0a0a0a]">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 z-10 px-4 pb-4 sm:px-6 sm:pb-6 md:px-9 md:pb-10">
            <div className="w-6 md:w-9 h-0.5 bg-[#E5C583] mb-1.5 md:mb-4 rounded-full" />
            <h2 className="font-bodoni text-[18px] sm:text-[24px] md:text-[38px] font-bold leading-[1.1] tracking-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.75)]">
              Welcome<br className="hidden md:inline" /> <span className="text-[#E5C583] drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)]">Back.</span>
            </h2>
            ...
            <div className="flex gap-4 sm:gap-6 mt-2 md:mt-4 pt-2 md:pt-0 border-t border-white/15 md:border-t-0">
              {[['120K+', 'Members'], ['50+', 'Collections'], ['🌍', 'Worldwide']].map(([num, lbl]) => (
                <div key={lbl}>
                  <div className="font-inter text-xs sm:text-sm font-bold text-[#E5C583] drop-shadow-[0_1px_4px_rgba(0,0,0,0.85)]">{num}</div>
