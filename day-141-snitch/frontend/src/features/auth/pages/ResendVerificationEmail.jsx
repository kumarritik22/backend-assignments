  ...
  const renderResendVerificationCard = () => {
    if (isSubmitting) {
      return <div className="loading-state w-full max-w-md bg-white dark:bg-[#111111] border border-black/10 dark:border-[#2A2A2A] rounded-2xl shadow-xl dark:shadow-2xl flex items-center flex-col justify-center p-8 sm:p-12 animate-[fadeInUp_0.4s_ease_both]">
        ...
        <h2 className="font-bodoni text-2xl font-bold tracking-tight text-[#121212] dark:text-white text-center mb-2">Sending Link...</h2>
        <p className="font-inter text-[#636059] dark:text-[#888888] text-sm leading-relaxed text-center mb-4">Please wait while we prepare your secure verification link.</p>
      </div>
    } else if (error) {
      return <div className="error-state w-full max-w-md bg-white dark:bg-[#111111] border border-black/10 dark:border-[#2A2A2A] rounded-2xl shadow-xl dark:shadow-2xl flex items-center flex-col justify-center p-8 sm:p-12 animate-[fadeInUp_0.4s_ease_both]">
        ...
        <h2 className="font-bodoni text-2xl font-bold tracking-tight text-[#121212] dark:text-white text-center mb-2">Unable to Send Link</h2>
      ...
      return <div className="success-state w-full max-w-md bg-white dark:bg-[#111111] border border-black/10 dark:border-[#2A2A2A] rounded-2xl shadow-xl dark:shadow-2xl flex items-center flex-col justify-center p-8 sm:p-12 animate-[fadeInUp_0.4s_ease_both]">
        ...
        {verificationType === "emailSent" && (
          <p className="font-inter text-[#636059] dark:text-[#888888] text-sm leading-relaxed text-center mb-7">We've sent a new verification link to your email address. Please check your inbox and spam folder.</p>
        )}
        <Link 
          to="/login"
      ...
      return <div className="form-state w-full max-w-md bg-white dark:bg-[#111111] border border-black/10 dark:border-[#2A2A2A] rounded-2xl shadow-xl dark:shadow-2xl flex items-center flex-col justify-center p-8 sm:p-12 animate-[fadeInUp_0.4s_ease_both]">
        ...
        <h3 className="font-bodoni text-[#121212] dark:text-white text-2xl font-bold tracking-tight mb-2">Resend Verification Link</h3>
        <p className="font-inter text-[#636059] dark:text-[#888888] text-sm leading-relaxed text-center mb-6">Didn't receive the email? Enter your registered email address below and we'll send you a new secure link.</p>
        {localError && (
