  ...
  return (
    <div className="min-h-screen bg-[#F6F5F2] dark:bg-[#0c0c0c] text-[#121212] dark:text-white">
      ...
      <main className="max-w-350 mx-auto px-5 sm:px-8 py-10 sm:py-14">
        ...
        {/* ── Content States ── */}
        {error ? (
          <div className="flex items-start gap-3 bg-red-500/10 border border-red-500/25 rounded-lg px-5 py-4 animate-[fadeIn_0.5s_ease_both]">
            ...
            <div>
              <h3 className="font-inter text-[13px] font-bold text-red-600 dark:text-red-300 mb-1">Error Loading Products</h3>
              <p className="font-inter text-[12px] text-red-600/80 dark:text-red-300/80">{error}</p>
            </div>
          </div>
        ) : isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 xl:gap-8">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
              <div key={n} className="animate-pulse bg-white dark:bg-[#111] border border-black/5 dark:border-white/5 rounded-xl overflow-hidden shadow-xs">
                <div className="aspect-3/4 bg-[#ECEAE4] dark:bg-[#1a1a1a]" />
                <div className="p-5">
                  <div className="h-5 bg-[#ECEAE4] dark:bg-[#1a1a1a] rounded w-3/4 mb-3" />
                  <div className="h-3 bg-[#ECEAE4] dark:bg-[#1a1a1a] rounded w-full mb-2" />
                  <div className="h-3 bg-[#ECEAE4] dark:bg-[#1a1a1a] rounded w-2/3 mb-4" />
          ...
          /* Empty State */
          <div className="flex flex-col items-center justify-center bg-white dark:bg-[#111] border border-black/5 dark:border-white/5 rounded-2xl py-24 px-6 text-center animate-[fadeIn_0.5s_ease_both] shadow-sm">
            <div className="w-20 h-20 bg-[#F6F5F2] dark:bg-[#1a1a1a] rounded-full flex items-center justify-center mb-6 border border-black/5 dark:border-white/5">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-[#888] dark:text-[#555]">
                <rect x="3" y="3" width="18" height="18" rx="2" ry="2" />
                <line x1="9" y1="3" x2="9" y2="21" />
              </svg>
            </div>
            <h3 className="font-bodoni text-[28px] font-bold text-[#121212] dark:text-white mb-2">No Products Yet</h3>
            <p className="font-inter text-sm text-[#636059] dark:text-[#777] max-w-md mb-8 leading-relaxed">
                ...
                <div onClick={() => {navigate(`/seller/product/${product._id}`)}} key={product._id} className="group relative bg-white dark:bg-[#141414] border border-black/5 dark:border-white/10 rounded-xl overflow-hidden hover:border-gold/40 dark:hover:border-gold/30 transition-all duration-300 shadow-sm hover:shadow-xl dark:hover:shadow-2xl flex flex-col cursor-pointer">
                  ...
                  <div className="relative aspect-3/4 w-full bg-white dark:bg-[#0e0e0e] overflow-hidden">
                    {coverImg ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center text-[#888] dark:text-[#333]">
                        No Image
                      </div>
                    )}
                    ...
                    <div className="absolute top-3 left-3 flex flex-col gap-2">
                      <div className="inline-flex items-center justify-center bg-black/70 backdrop-blur-md px-1.5 py-1.5 rounded-[3px] border border-gold/35">
                    ...
                    {product.images?.length > 1 && (
                      <div className="absolute bottom-3 right-3 inline-flex items-center justify-center bg-black/70 backdrop-blur-md px-1.75 py-1.5 rounded-[3px] gap-1.5 border border-white/15">
                        ...
                        <span className="font-inter text-[8.5px] font-semibold text-white/90 leading-none">
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <p className="font-inter text-[12px] text-[#636059] dark:text-[#8e8e8e] leading-relaxed mb-4 line-clamp-2">
                      {product.description || 'No description provided.'}
                    </p>
                    
                    <div className="flex items-end justify-between mt-auto pt-2 border-t border-black/5 dark:border-white/5">
                      <div>
                        <span className="font-inter text-[9px] text-[#888] dark:text-[#555] font-bold tracking-widest uppercase block mb-1">
                          Price
                        </span>
                      ...
                      <div className="text-right">
                        <span className="font-inter text-[9px] text-[#888] dark:text-[#444] block">
                          Added
                        </span>
                        <span className="font-inter text-[10px] text-[#636059] dark:text-[#666]">
