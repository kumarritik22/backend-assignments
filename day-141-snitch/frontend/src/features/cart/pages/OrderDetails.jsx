...
const OrderDetails = () => {
  ...
  if (error || !order) {
    return <div className="min-h-screen bg-[#F6F5F2] dark:bg-[#0a0a0a] flex flex-col items-center justify-center px-4">
      <div className="bg-white dark:bg-[#121212] border border-black/5 dark:border-white/10 rounded-2xl p-8 max-w-md w-full text-center space-y-4 shadow-xl dark:shadow-2xl">
        <h2 className="font-bodoni text-2xl font-bold text-[#121212] dark:text-white">Order not found.</h2>
        <p className="font-inter text-xs text-[#636059] dark:text-[#888] leading-relaxed">We could not locate this order details. It may not exist or you may need to sign in.</p>
  ...
  return (
    <div className="min-h-screen bg-[#F6F5F2] dark:bg-[#0a0a0a] text-[#121212] dark:text-white pt-6 sm:pt-8 pb-16 px-4 sm:px-6 lg:px-12 selection:bg-gold/30">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <h1 className="font-bodoni text-3xl sm:text-4xl lg:text-5xl font-bold text-[#121212] dark:text-white tracking-tight leading-tight">
                Order Details
              </h1>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 shrink-0 print:hidden">
              <button 
                ...
                className="px-4 py-2.5 rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 border border-black/10 dark:border-white/10 hover:border-gold/40 text-[#121212] dark:text-white font-inter text-xs font-semibold tracking-wider uppercase whitespace-nowrap transition-all duration-300 flex items-center gap-2 cursor-pointer active:scale-95"
              >
          ...
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-4 font-inter text-xs text-[#636059] dark:text-[#888] pt-2 border-t border-black/5 dark:border-white/5">
            ...
            <span>Placed on <strong className="text-[#121212] dark:text-white font-medium">
              {order?.createdAt 
            ...
            <span className="hidden sm:inline w-1 h-1 rounded-full bg-[#ccc] dark:bg-[#444]" />
        ...
        <div className="bg-white dark:bg-[#121212]/90 border border-black/5 dark:border-white/10 rounded-2xl p-6 sm:p-8 backdrop-blur-xl shadow-md dark:shadow-2xl relative overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-black/5 dark:border-white/5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-inter font-bold text-sm uppercase tracking-wider text-[#121212] dark:text-white">
                  Shipment Status
                </h3>
                <p className="font-inter text-xs text-[#636059] dark:text-[#777] mt-0.5">
                  Courier: <span className="text-[#333] dark:text-[#bbb]">Bluedart Express (Tracking: VEL-BLU-992140)</span>
                </p>
              </div>
            </div>

            <span className="self-start sm:self-auto px-3.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400 font-inter text-[11px] font-bold tracking-widest uppercase">
            ...
            <div className="hidden md:grid grid-cols-5 gap-2 relative">
              ...
              {ORDER_TIMELINE.map((step, index) => (
                <div key={index} className="flex flex-col items-center text-center relative z-10">
                  <div 
                    className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
                      step.completed 
                        ...
                        : step.active 
                        ? 'bg-[#f7f4ed] dark:bg-[#1a1a1a] border-2 border-gold text-gold ring-4 ring-gold/20 shadow-[0_0_20px_rgba(201,169,110,0.3)] animate-pulse' 
                  ...
                  <span className={`font-inter text-[11px] font-bold tracking-wider uppercase mt-3 ${step.active ? 'text-gold' : step.completed ? 'text-[#121212] dark:text-white' : 'text-[#888] dark:text-[#666]'}`}>
                    {step.title}
                  </span>
                  <span className="font-inter text-[10px] text-[#888] dark:text-[#555] mt-0.5 max-w-28 leading-tight">
                    {step.date}
                  </span>
                </div>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="bg-white dark:bg-[#121212]/90 border border-black/5 dark:border-white/10 rounded-2xl p-6 sm:p-8 backdrop-blur-xl shadow-md dark:shadow-2xl">
              <div className="flex items-center justify-between border-b border-black/5 dark:border-white/5 pb-5 mb-6">
              ...
              <div className="divide-y divide-black/5 dark:divide-white/5">
                {order?.orderItems?.map((item, index) => (
                  <div key={item.id} className="py-6 first:pt-0 last:pb-0 flex flex-col sm:flex-row items-start sm:items-center gap-5">
                    {/* Thumbnail */}
                    <div className="w-20 h-24 sm:w-24 sm:h-28 rounded-xl overflow-hidden bg-[#f0ede6] dark:bg-[#181818] shrink-0 border border-black/5 dark:border-white/10 relative group">
                      <img 
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
                        <div>
                          <h4 className="font-bodoni text-lg font-bold text-[#121212] dark:text-white hover:text-gold transition-colors cursor-pointer">
                            {item.title}
                          </h4>
                          {item.attributes && Object.keys(item.attributes).length > 0 && (
                            <div className="flex flex-wrap items-center gap-2 mt-1.5">
                              {Object.entries(item.attributes).map(([key, val]) => (
                                <span key={key} className="px-2 py-0.5 rounded-md bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 text-[10px] font-inter text-[#636059] dark:text-[#aaa] capitalize">
                                  <span className="text-[#888] dark:text-[#666]">{key}: </span>
                                  <span className="text-[#121212] dark:text-white font-medium">{val}</span>
                                </span>
                              ))}
                            </div>
                          )}
                        ...
                        <div className="text-left sm:text-right">
                          <p className="font-bodoni text-lg font-bold text-[#121212] dark:text-white">
                            {CURRENCY_SYMBOLS[item.price?.currency] || '₹'}{Number(item.price?.amount).toLocaleString()}
                          </p>
                          <p className="font-inter text-[11px] text-[#888] dark:text-[#666]">
                            Qty: {item.quantity}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 pt-2">
                        ...
                        <Link 
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/5 dark:bg-white/5 hover:bg-gold/10 border border-black/10 dark:border-white/10 hover:border-gold/30 text-[#636059] dark:text-[#ccc] hover:text-gold font-inter text-[10px] font-semibold tracking-wider uppercase transition-all duration-200 cursor-pointer"
                        >
                        ...
                        <button 
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-black/5 dark:bg-white/5 hover:bg-gold/10 border border-black/10 dark:border-white/10 hover:border-gold/30 text-[#636059] dark:text-[#ccc] hover:text-gold font-inter text-[10px] font-semibold tracking-wider uppercase transition-all duration-200 cursor-pointer active:scale-95"
                        >
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-white dark:bg-[#121212]/90 border border-black/5 dark:border-white/10 rounded-2xl p-6 sm:p-7 backdrop-blur-xl shadow-md dark:shadow-2xl space-y-5">
              <h3 className="font-inter font-bold text-xs uppercase tracking-[0.2em] text-[#636059] dark:text-[#888] border-b border-black/5 dark:border-white/5 pb-4">
                Financial Summary
              </h3>

              <div className="space-y-3 font-inter text-xs">
                {/* Items Subtotal */}
                <div className="flex justify-between text-[#636059] dark:text-[#888]">
                ...
                <div className="flex justify-between text-[#636059] dark:text-[#888]">
                  ...
                  <span className="text-[#636059] dark:text-[#bbb]">
                    Included ({CURRENCY_SYMBOLS[order?.price?.currency] || '₹'}{Number(order?.price?.amount * 0.18 / 1.18).toFixed(0)})
                  </span>
                </div>

                {/* Grand Total Container */}
                <div className="border-t border-black/5 dark:border-white/10 pt-4 mt-2 space-y-1">
                  <div className="flex justify-between items-baseline">
                    <span className="font-inter font-bold text-xs uppercase tracking-widest text-[#121212] dark:text-white">Grand Total</span>
                    <span className="font-bodoni text-2xl font-bold text-gold">
                      {CURRENCY_SYMBOLS[order?.price?.currency] || '₹'}{Number(order?.price?.amount).toLocaleString()}
                    </span>
                  </div>
                  <p className="text-[10px] text-[#888] dark:text-[#666] text-right">
              ...
              <div className="bg-[#F6F5F2] dark:bg-[#181818] border border-black/5 dark:border-white/5 rounded-xl p-3.5 space-y-1.5">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-inter text-[#636059] dark:text-[#777] uppercase text-[10px] tracking-wider">Payment Method</span>
                  <span className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 font-inter text-[10px] uppercase font-bold tracking-wider">
                    <ShieldCheck className="w-3.5 h-3.5" /> Paid
                  </span>
                </div>
                <p className="font-inter text-xs text-[#121212] dark:text-white font-medium">Razorpay ({order?.price?.currency || 'INR'})</p>
                <p className="font-mono text-[10px] text-[#888] dark:text-[#555]">TXN: {order?.razorpay?.paymentId || order?.razorpay?.orderId}</p>
              </div>
            </div>

            {/* Delivery Destination */}
            <div className="bg-white dark:bg-[#121212]/90 border border-black/5 dark:border-white/10 rounded-2xl p-6 sm:p-7 backdrop-blur-xl shadow-md dark:shadow-2xl space-y-4">
              <h3 className="font-inter font-bold text-xs uppercase tracking-[0.2em] text-[#636059] dark:text-[#888] border-b border-black/5 dark:border-white/5 pb-4">
                Delivery Address
              </h3>

              <div className="font-inter text-xs space-y-1.5 text-[#636059] dark:text-[#aaa]">
                <p className="font-bold text-[#121212] dark:text-white text-sm">
                  {order?.shippingAddress?.fullname || order?.user?.fullname || 'Velora Client'}
                </p>

                {order?.shippingAddress?.addressLine1 ? (
                  <>
                    <p className="text-[#444] dark:text-[#ccc] pt-1 leading-relaxed">
                      {order.shippingAddress.addressLine1}
                      {order.shippingAddress.addressLine2 ? `, ${order.shippingAddress.addressLine2}` : ''}
                    </p>
                    <p className="text-[#636059] dark:text-[#888]">
                    ...
                    <p className="text-[#888] dark:text-[#666] uppercase text-[10px] font-medium tracking-wider">{order.shippingAddress.country || 'India'}</p>
                    
                    <div className="pt-2.5 mt-2.5 border-t border-black/5 dark:border-white/5 space-y-1">
                      <p className="text-[#888] dark:text-[#666]">Contact: <span className="text-[#121212] dark:text-white font-mono">{order.shippingAddress.contact || order?.user?.contact}</span></p>
                      <p className="text-[#888] dark:text-[#666]">Email: <span className="text-[#636059] dark:text-[#888]">{order?.user?.email}</span></p>
                    </div>
                  </>
                ) : (
                  <>
                    <p className="pt-2 text-[#888] dark:text-[#666]">Phone: <span className="text-[#636059] dark:text-[#888]">{order?.user?.contact || 'Not provided'}</span></p>
                    <p className="text-[#888] dark:text-[#666]">Email: <span className="text-[#636059] dark:text-[#888]">{order?.user?.email}</span></p>
                  </>
                )}
              </div>
      ...
      {toastNotification && (
        <div className="fixed top-24 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-xl bg-white/95 dark:bg-[#141414]/95 border border-gold/40 text-[#121212] dark:text-white p-4 sm:p-5 rounded-2xl shadow-2xl backdrop-blur-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 animate-[fadeIn_0.3s_ease_both]">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="font-inter text-xs text-[#636059] dark:text-[#ccc] mt-0.5 leading-relaxed">
          ...
          <div className="flex items-center gap-3 self-end sm:self-center shrink-0">
            ...
            <button 
              ...
              className="text-[#888] hover:text-[#121212] dark:hover:text-white transition-colors text-base p-1 cursor-pointer"
            >
              ✕
            </button>
          </div>
