...
import { Package, ArrowRight, ShieldCheck, Sparkles, ShoppingBag, ChevronRight } from "lucide-react";
          ...
          {orders.map((order) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 border-b border-white/5">
                ...
                <span className="self-start sm:self-auto inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-inter text-[10px] font-bold tracking-widest uppercase">
