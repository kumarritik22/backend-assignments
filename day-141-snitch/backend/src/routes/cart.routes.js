...
import { validateAddToCart, validateCreateOrder, validateDecrementCartItemQuantity, validateIncrementCartItemQuantity } from "../validators/cart.validator.js";
...
router.post("/payment/create/order", authenticateUser, validateCreateOrder, createOrderController);
